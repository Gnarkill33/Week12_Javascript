...
const makeTwo = () => {
	...
	const num2 = 7;
	//Ваш код
	const diffTwo = num1 - num2;
	resultTwo.textContent = diffTwo;
};
...
const makeThree = () => {
	...
	const num2 = 4;
	//Ваш код
	const multiThree = num1 * num2;
	resultThree.textContent = multiThree;
};
...
const makeFour = () => {
	...
	const num2 = 2;
	//Ваш код
	const divFour = num1 / num2;
	resultFour.textContent = divFour;
};
...
const makeFive = () => {
	...
	const power = 4;
	//Ваш код
	const powerFive = Math.pow(num, power); 
	resultFive.textContent = powerFive;
};
...
const makeSix = () => {
	...
	const num2 = 5;
	//Ваш код
	const divSix = num1 / num2;
	resultSix.textContent = divSix;
};
...
const makeSeven = () => {
	...
	const num2 = 7;
	//Ваш код
	const moduloSeven = num1 % num2;
	resultSeven.textContent = moduloSeven;
};
...
const makeEight = () => {
	const num1 = 123;
	//Ваш код
	const moduloEight = num1 % 10;
	resultEight.textContent = moduloEight;
};
...
const makeNine = () => {
	const num1 = 4567;
	//Ваш код
	const moduloNine = num1 % 100;
	resultNine.textContent = moduloNine;
};
...
const makeEleven = () => {
	...
	const num1 = 5;
	const num2 = 2;
	const moduloEleven = num1 % num2;
	resultEleven.textContent = moduloEleven;
};
...
const makeTwelve = () => {
	...
	const str2 = 'World!';
	//Ваш код
	const combinedTwelve = str1 + str2;
	resultTwelve.textContent = combinedTwelve;
};
...
const makeThirteen = () => {
	...
	//Ваш код
	const lengthThirteen = str.length;
	resultThirteen.textContent = lengthThirteen;
};
...
const makeFourteen = () => {
	const str = 'JavaScript';
	//Ваш код
	const lowerCaseFourteen = str.toLowerCase();
	resultFourteen.textContent = lowerCaseFourteen;
};
...
const makeFifteen = () => {
	const str = 'JavaScript';
	//Ваш код
	const upperCaseFifteen = str.toUpperCase();
	resultFifteen.textContent = upperCaseFifteen;
};
...
const makeSixteen = () => {
	const str = 'JavaScript';
	//Ваш код
	const substringSixteen = str.substring(3);
	resultSixteen.textContent = substringSixteen;
};
...
const makeSeventeen = () => {
	const str = 'JavaScript';
	//Ваш код
	const substringSeventeen = str.substring(3,7);
	resultSeventeen.textContent = substringSeventeen;
};
...
const makeEighteen = () => {
	...
	//Ваш код
	const replacedEighteen = str.replace(/world/g,'JavaScript');
	resultEighteen.textContent = replacedEighteen;
};
...
const makeNineteen = () => {
	const str = 'Hello, world!';
	//Ваш код
	const substringNineteen = str.substr(7, 6);
	resultNineteen.textContent = substringNineteen;
...
const makeTwenty = () => {
	//Ваш код
	const maxTwenty = Math.max(10, 25, 5, 30, 15);
	resultTwenty.textContent = maxTwenty;
};
...
const makeTwentyOne = () => {
	//Ваш код
	const randomTwentyOne = Math.round(Math.random() * 10);
	resultTwentyOne.textContent = randomTwentyOne;
};
...
const makeTwentyTwo = () => {
	//Ваш код
	const minTwentyTwo = Math.min(10, 25, 5, 30, 15);
	resultTwentyTwo.textContent = minTwentyTwo;
};
...
const makeTwentyThree = () => {
	...
	const a = 2;
	const b = 5;
	const powerTwentyThree = Math.pow(a,b);
	resultTwentyThree.textContent = powerTwentyThree;
};
...
const makeTwentyFour = () => {
	//Ваш код
	const minTwentyFour = Math.min(7, 3, 11, 5, 9);
	resultTwentyFour.textContent = minTwentyFour;
};
...
const makeTwentyFive = () => {
	//Ваш код
	const maxTwentyFive = Math.max(7, 3, 11, 5, 9);
	resultTwentyFive.textContent = maxTwentyFive;
};
...
const makeTwentySix = () => {
	//Ваш код
	const randomTwentySix = Math.random().toFixed(4);
	resultTwentySix.textContent = randomTwentySix;
};
...
const makeTwentySeven = () => {
	//Ваш код
	const randomTwentySeven = Math.round(Math.random() * (100 - 50) + 50);
	resultTwentySeven.textContent = randomTwentySeven;
};
...
const makeTwentyEight = () => {
	//Ваш код
	const a = 4.47;
	const roundedTwentyEight = Math.ceil(a);
	resultTwentyEight.textContent = roundedTwentyEight;
};
...
const makeTwentyNine = () => {
	//Ваш код
	const a = 16;
	const squaredTwentyNine = Math.sqrt(a);
	resultTwentyNine.textContent = squaredTwentyNine;
};
...
const makeThirty = () => {
	//Ваш код
	const a = 25;
	const squaredThirty = Math.sqrt(a);
	resultThirty.textContent = squaredThirty;
};
